import { Mail, Linkedin, Download, MapPin, ChevronDown } from "lucide-react"
  ...
  return (
    <div className="my-20 max-w-4xl mx-auto">
			<div className="grid grid-cols-1 md:grid-cols-3 gap-8">
				...
				<h1 className="text-4xl font-bold mt-6 mb-2 text-foreground">{personalInfo.full_name}</h1>
				{personalInfo.title && <p className="text-xl mb-4 text-muted-foreground">{personalInfo.title}</p>}
				...
				<div className="mt-8 flex flex-wrap gap-2">
					...
					<Button variant="outline" size="sm" asChild>
						...
						<svg className="h-5 w-5 mr-2" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
							<title>GitHub</title>
